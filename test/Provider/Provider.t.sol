...
import { MAX_MESSAGE_LENGTH, SLOT_CURRENT_CONTEXT_HASH, SLOT_HELD_STAKE, SLOT_HELD_MSG_VALUE } from "@BondRoute/Definitions.sol";

contract ProviderHarness is Provider {

    constructor( address eip1153_detector ) Provider( eip1153_detector ) {}
...
contract ProviderTest is Test {
    ...
    function setUp() public
    {
        ...
        provider_harness  =  new ProviderHarness( address(eip1153_detector) );
    ...
    function test_transfer_funding_pulls_erc20_from_user() public
    {
        ...
        provider_harness.exposed_write_smart_var( SLOT_CURRENT_CONTEXT_HASH, HashLib.calc_context_hash( mock_protocol, context ) );
    ...
    function test_transfer_funding_updates_context_hash() public
    {
        ...
        provider_harness.exposed_write_smart_var( SLOT_CURRENT_CONTEXT_HASH, initial_hash );
        ...
        uint256 actual_new_hash    =  provider_harness.exposed_read_smart_var( SLOT_CURRENT_CONTEXT_HASH );
    ...
    function test_transfer_funding_uses_stake_first() public
    {
        ...
        provider_harness.exposed_write_smart_var( SLOT_CURRENT_CONTEXT_HASH, HashLib.calc_context_hash( mock_protocol, context ) );
        provider_harness.exposed_write_smart_var( SLOT_HELD_STAKE, 100e6 );
        ...
        assertEq( provider_harness.exposed_read_smart_var( SLOT_HELD_STAKE ), 0, "Should consume all stake" );
    }
    ...
    function test_transfer_funding_erc20_with_matching_stake() public
    {
        ...
        provider_harness.exposed_write_smart_var( SLOT_CURRENT_CONTEXT_HASH, HashLib.calc_context_hash( mock_protocol, context ) );
        provider_harness.exposed_write_smart_var( SLOT_HELD_STAKE, 1000e6 );
        ...
        assertEq( provider_harness.exposed_read_smart_var( SLOT_HELD_STAKE ), 500e6, "Should leave 500 in stake" );
    }
    ...
    function test_transfer_funding_partial_from_stake_partial_from_user() public
    {
        ...
        provider_harness.exposed_write_smart_var( SLOT_CURRENT_CONTEXT_HASH, HashLib.calc_context_hash( mock_protocol, context ) );
        provider_harness.exposed_write_smart_var( SLOT_HELD_STAKE, 300e6 );
    ...
    function test_transfer_funding_uses_msg_value_for_native() public
    {
        ...
        provider_harness.exposed_write_smart_var( SLOT_CURRENT_CONTEXT_HASH, HashLib.calc_context_hash( mock_protocol, context ) );
        provider_harness.exposed_write_smart_var( SLOT_HELD_MSG_VALUE, 1 ether );
        ...
        assertEq( provider_harness.exposed_read_smart_var( SLOT_HELD_MSG_VALUE ), 0, "Should consume all msg.value" );
    }
    ...
    function test_transfer_funding_native_with_native_stake() public
    {
        ...
        provider_harness.exposed_write_smart_var( SLOT_CURRENT_CONTEXT_HASH, HashLib.calc_context_hash( mock_protocol, context ) );
        provider_harness.exposed_write_smart_var( SLOT_HELD_STAKE, 1 ether );
        provider_harness.exposed_write_smart_var( SLOT_HELD_MSG_VALUE, 1 ether );
        ...
        assertEq( provider_harness.exposed_read_smart_var( SLOT_HELD_STAKE ), 0, "Should consume stake first" );
        assertEq( provider_harness.exposed_read_smart_var( SLOT_HELD_MSG_VALUE ), 0, "Should consume msg.value" );
    }
    ...
    function test_transfer_funding_reverts_on_context_mismatch() public
    {
        ...
        provider_harness.exposed_write_smart_var( SLOT_CURRENT_CONTEXT_HASH, 0x1234 );
    ...
    function test_transfer_funding_updates_held_state() public
    {
        ...
        provider_harness.exposed_write_smart_var( SLOT_CURRENT_CONTEXT_HASH, HashLib.calc_context_hash( mock_protocol, context ) );
        provider_harness.exposed_write_smart_var( SLOT_HELD_STAKE, 500e6 );

        vm.prank( address(mock_protocol) );
        provider_harness.transfer_funding( RECIPIENT, usdc, 300e6, context );

        assertEq( provider_harness.exposed_read_smart_var( SLOT_HELD_STAKE ), 200e6, "Should update held stake" );
    }
    ...
    function test_transfer_funding_stake_greater_than_funding_erc20() public
    {
        ...
        assertEq( provider_harness.exposed_read_smart_var( SLOT_HELD_STAKE ), 500e6, "Should leave 500 stake for refund" );
    }
    ...
    function test_transfer_funding_stake_less_than_funding_erc20() public
    {
        ...
        provider_harness.exposed_write_smart_var( SLOT_CURRENT_CONTEXT_HASH, HashLib.calc_context_hash( mock_protocol, context ) );
        provider_harness.exposed_write_smart_var( SLOT_HELD_STAKE, 200e6 );
    ...
    function test_transfer_funding_consumed_less_than_stake() public
    {
        ...
        assertEq( provider_harness.exposed_read_smart_var( SLOT_HELD_STAKE ), 700e6, "Should leave 700 stake for refund" );
    }
    ...
    function test_transfer_funding_native_msg_value_partially_consumed() public
    {
        ...
        provider_harness.exposed_write_smart_var( SLOT_CURRENT_CONTEXT_HASH, HashLib.calc_context_hash( mock_protocol, context ) );
        provider_harness.exposed_write_smart_var( SLOT_HELD_MSG_VALUE, 2 ether );

        vm.prank( address(mock_protocol) );
        provider_harness.transfer_funding( RECIPIENT, IERC20(address(0)), 0.8 ether, context );

        assertEq( provider_harness.exposed_read_smart_var( SLOT_HELD_MSG_VALUE ), 1.2 ether, "Should leave 1.2 ETH for refund" );
    }
    ...
    function test_transfer_funding_native_stake_greater_than_funding() public
    {
        ...
        provider_harness.exposed_write_smart_var( SLOT_CURRENT_CONTEXT_HASH, HashLib.calc_context_hash( mock_protocol, context ) );
        provider_harness.exposed_write_smart_var( SLOT_HELD_STAKE, 3 ether );

        vm.prank( address(mock_protocol) );
        provider_harness.transfer_funding( RECIPIENT, IERC20(address(0)), 1 ether, context );

        assertEq( provider_harness.exposed_read_smart_var( SLOT_HELD_STAKE ), 2 ether, "Should leave 2 ETH stake for refund" );
    ...
    function test_transfer_funding_native_stake_and_msg_value_partial_consumption() public
    {
        ...
        provider_harness.exposed_write_smart_var( SLOT_CURRENT_CONTEXT_HASH, HashLib.calc_context_hash( mock_protocol, context ) );
        provider_harness.exposed_write_smart_var( SLOT_HELD_STAKE, 2 ether );
        provider_harness.exposed_write_smart_var( SLOT_HELD_MSG_VALUE, 3 ether );

        vm.prank( address(mock_protocol) );
        provider_harness.transfer_funding( RECIPIENT, IERC20(address(0)), 2.5 ether, context );

        assertEq( provider_harness.exposed_read_smart_var( SLOT_HELD_STAKE ), 0, "Should consume all stake" );
        assertEq( provider_harness.exposed_read_smart_var( SLOT_HELD_MSG_VALUE ), 2.5 ether, "Should leave 2.5 ETH msg.value for refund" );
