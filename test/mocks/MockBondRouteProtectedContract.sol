...
contract MockBondRouteProtectedContract is BondRouteProtected {
    ...
    function BondRoute_get_call_constraints( bytes calldata call, IERC20 /* preferred_stake_token */, TokenAmount[] memory /* preferred_fundings */ ) public view override returns ( BondConstraints memory )
    {
