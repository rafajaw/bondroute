...
contract MockProtocol is IBondRouteProtected {
    ...
    function BondRoute_get_call_constraints( bytes calldata /* call */, IERC20 /* preferred_stake_token */, TokenAmount[] memory /* preferred_fundings */ ) external pure override returns ( BondConstraints memory )
    {
