...
import { IERC20, TokenAmount, PossiblyBondFarming } from "@BondRouteProtected/BondRouteProtected.sol";
...
contract CoreTest is Test {
    ...
    function setUp() public
    {
        ...
        core_harness      =  new CoreHarness( address(eip1153_detector) );
    ...
    function test_execute_bond_context_cleared_after_success() public
    {
        ...
        uint256 context_before  =  core_harness.exposed_read_smart_var( SLOT_CURRENT_CONTEXT_HASH );
        ...
        uint256 context_after  =  core_harness.exposed_read_smart_var( SLOT_CURRENT_CONTEXT_HASH );
