 ...
 * `vm.etch` only copies bytecode, losing all storage state (sweeper, EIP-1153 detector, EIP-712 domain, etc.)
...
contract BondRouteProtectedTest is Test {
    ...
    function setUp() public
    {
        ...
        bond_route        =  new BondRoute( SWEEPER, address(eip1153_detector) );
        ...
        //         including constructor-initialized values like sweeper, EIP-1153 detector, and EIP-712 domain.
    ...
    function _create_and_execute_bond( ExecutionData memory execution_data ) internal returns ( BondStatus status, bytes memory output )
    {
        ...
        vm.prank( USER );
        bond_route.create_bond( commitment_hash, execution_data.stake, block.timestamp + 1 hours );
    ...
    function test_entry_point_validates_context( ) public
    {
        ...
        mock_protected.configure_constraints( BondConstraints({
            ...
            execution_delay: Range({ min: 60, max: 0 }),
            creation_time: Range({ min: 0, max: 0 }),
            execution_time: Range({ min: 0, max: 0 })
        }));
        ...
        vm.prank( USER );
        vm.expectRevert( abi.encodeWithSelector( PossiblyBondFarming.selector, EXECUTION_TOO_SOON, bytes32(uint256(60)) ) );
    ...
    function test_entry_point_delegates_to_target( ) public
    {
        ...
        mock_protected.configure_constraints( BondConstraints({
            min_stake: TokenAmount({ token: weth, amount: 10e18 }),
            min_fundings: new TokenAmount[](0),
            execution_delay: Range({ min: 0, max: 0 }),
            creation_time: Range({ min: 0, max: 0 }),
            execution_time: Range({ min: 0, max: 0 })
        }));
    ...
    function test_validate_enforces_min_creation_time( ) public
    {
        ...
        mock_protected.configure_constraints( BondConstraints({
            ...
            min_fundings: new TokenAmount[](0),
            execution_delay: Range({ min: 0, max: 0 }),
            creation_time: Range({ min: block.timestamp + 1 hours, max: 0 }),
            execution_time: Range({ min: 0, max: 0 })
        }));
    ...
    function test_validate_enforces_max_creation_time( ) public
    {
        ...
        mock_protected.configure_constraints( BondConstraints({
            ...
            min_fundings: new TokenAmount[](0),
            execution_delay: Range({ min: 0, max: 0 }),
            creation_time: Range({ min: 0, max: max_creation_time }),
            execution_time: Range({ min: 0, max: 0 })
        }));

        BondContext memory context  =  BondContext({
            user: USER,
            creation_time: actual_creation_time,  // Created now (too late)
            creation_block: block.number,
    ...
    function test_validate_enforces_min_execution_delay( ) public
    {
        ...
        mock_protected.configure_constraints( BondConstraints({
            min_stake: TokenAmount({ token: weth, amount: 10e18 }),
            min_fundings: new TokenAmount[](0),
            execution_delay: Range({ min: 3600, max: 0 }),
            creation_time: Range({ min: 0, max: 0 }),
            execution_time: Range({ min: 0, max: 0 })
        }));
        ...
        vm.prank( USER );
        vm.expectRevert( abi.encodeWithSelector( PossiblyBondFarming.selector, EXECUTION_TOO_SOON, bytes32(uint256(3600)) ) );
        bond_route.execute_bond( execution_data );
    }
    ...
    function test_validate_enforces_max_execution_delay( ) public
    {
        ...
        mock_protected.configure_constraints( BondConstraints({
            min_stake: TokenAmount({ token: weth, amount: 10e18 }),
            min_fundings: new TokenAmount[](0),
            execution_delay: Range({ min: 0, max: 60 }),
            creation_time: Range({ min: 0, max: 0 }),
            execution_time: Range({ min: 0, max: 0 })
        }));
        ...
        vm.prank( USER );
        vm.expectRevert( abi.encodeWithSelector( PossiblyBondFarming.selector, EXECUTION_TOO_LATE, bytes32(uint256(60)) ) );
        bond_route.execute_bond( execution_data );
    }
    ...
    function test_validate_enforces_min_execution_time( ) public
    {
        ...
        mock_protected.configure_constraints( BondConstraints({
            ...
            execution_delay: Range({ min: 0, max: 0 }),
            creation_time: Range({ min: 0, max: 0 }),
            execution_time: Range({ min: min_execution_time, max: 0 })
        }));
    ...
    function test_validate_enforces_max_execution_time( ) public
    {
        ...
        mock_protected.configure_constraints( BondConstraints({
            ...
            execution_delay: Range({ min: 0, max: 0 }),
            creation_time: Range({ min: 0, max: 0 }),
            execution_time: Range({ min: 0, max: max_execution_time })
        }));
    ...
    function test_validate_allows_execution_within_absolute_time_window( ) public
    {
        ...
        mock_protected.configure_constraints( BondConstraints({
            ...
            execution_delay: Range({ min: 0, max: 0 }),
            creation_time: Range({ min: 0, max: 0 }),
            execution_time: Range({ min: min_execution_time, max: max_execution_time })
        }));
    ...
    function test_fundings_lib_pull_with_default_tip( ) public
    {
        TokenAmount[] memory fundings  =  new TokenAmount[](1);
        fundings[ 0 ]  =  TokenAmount({ token: usdc, amount: 1000e6 });
    ...
    function test_fundings_lib_send_with_default_tip( ) public
    {
        TokenAmount[] memory fundings  =  new TokenAmount[](1);
        fundings[ 0 ]  =  TokenAmount({ token: usdc, amount: 1000e6 });
