...
library SignatureValidator {
     ...
     */
    function is_valid_signature( address signer, bytes32 _hash, bytes memory signature, bool is_eip1271 )
     ...
     * @return bool True if signature is valid, false otherwise
     */
    function is_valid_ecdsa_signature( address signer, bytes32 _hash, bytes memory signature )
     ...
     * @return bool True if signature is valid, false otherwise
     */
    function is_valid_contract_signature( address signer, bytes32 _hash, bytes memory signature )
    internal view returns ( bool )
    {
