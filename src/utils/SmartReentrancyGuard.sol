...
abstract contract SmartReentrancyGuard {
    ...
    uint256 private constant _SMART_REENTRANCY_GUARD_BASE_SLOT  =  0x2ed53bc8675797c841da097b8f0c0baeba938f15b15be5ded2f2463c27f14c7f; // keccak256( "SmartReentrancyGuard.base_slot" )
    ...
    function _smart_enter_or_revert( bytes20 key ) private
    {
    ...
    function _smart_revert_if_entered( bytes20 key ) private view
    {
        bytes32 slot  =  bytes32(_SMART_REENTRANCY_GUARD_BASE_SLOT) ^ bytes32(key);
    ...
    function _has_entered_reentrancy_guard( bytes20 key ) internal view returns ( bool )
    {
        bytes32 slot  =  bytes32(_SMART_REENTRANCY_GUARD_BASE_SLOT) ^ bytes32(key);
    ...
    function _has_transient_storage_support( ) internal view returns ( bool )
    {
